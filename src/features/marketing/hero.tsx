...
export function Hero() {
  return (
    <section className="grid min-h-[680px] items-center gap-12 bg-linear-to-br from-white via-[#f7fbff] to-[#fbf9ff] px-[clamp(22px,7vw,120px)] py-[70px] max-[780px]:min-h-0 max-[780px]:grid-cols-1 max-[780px]:pt-12 min-[781px]:grid-cols-[1.05fr_0.95fr]">
      <div>
